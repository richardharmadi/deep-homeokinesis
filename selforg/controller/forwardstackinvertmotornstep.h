#ifndef __FWDSTACKINVERTMOTORNSTEP_H
#define __FWDSTACKINVERTMOTORNSTEP_H
 ...
 * (deep networks)
 */
class FWDStackInvertMotorNStep : public InvertMotorController{

public:
  vector<InvertMotorNStep*> controllers; // vector of controller that will be stacked

  FWDStackInvertMotorNStep(int buffersize, int nlayers);

  virtual void init(int sensornumber, int motornumber, RandGen* randGen = 0);

  virtual void addLayer(InvertMotorNStep* cont);
  
  virtual ~FWDStackInvertMotorNStep();
